 ...
 * <ul>
 *   <li>{@link pcm.impl.DateValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateValueImpl extends ValueImpl implements DateValue {
	...
	protected EClass eStaticClass() {
		return PcmPackage.Literals.DATE_VALUE;
	}
	...
	public void setValue(Date newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PcmPackage.DATE_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PcmPackage.DATE_VALUE__VALUE:
				return getValue();
		}
