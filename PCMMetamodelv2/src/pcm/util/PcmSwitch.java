...
public class PcmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PcmPackage.FEATURE_GROUP: {
				FeatureGroup featureGroup = (FeatureGroup)theEObject;
				T result = caseFeatureGroup(featureGroup);
				if (result == null) result = caseAbstractFeature(featureGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.CELL: {
				Cell cell = (Cell)theEObject;
				T result = caseCell(cell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.VALUE: {
				Value value = (Value)theEObject;
				T result = caseValue(value);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.INTEGER_VALUE: {
			...
			case PcmPackage.MULTIPLE: {
				Multiple multiple = (Multiple)theEObject;
				T result = caseMultiple(multiple);
				if (result == null) result = caseValue(multiple);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.NOT_AVAILABLE: {
				NotAvailable notAvailable = (NotAvailable)theEObject;
				T result = caseNotAvailable(notAvailable);
				if (result == null) result = caseValue(notAvailable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = caseValue(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.PARTIAL: {
				Partial partial = (Partial)theEObject;
				T result = casePartial(partial);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmPackage.DATE_VALUE: {
