...
public class GreetingServiceImpl extends RemoteServiceServlet implements
	...
	public void init() throws ServletException {
		...
		models_0.add("Comparison_of_Business_Process_Modeling_Notation_tools.pcm");
		...
		models_0.add("Comparison_of_Canadian-tax_preparation_software_for_personal_use.pcm");
		...
		models_0.add("Comparison_of_dental_practice_management_software.pcm");
		...
		models_0.add("Comparison_of_embedded_computer_systems_on_board_the_Mars_rovers.pcm");
		...
		models_0.add("Comparison_of_free_software_e-commerce_web_application_frameworks.pcm");
